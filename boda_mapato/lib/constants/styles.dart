...
mixin AppStyles {
  // Static Text Styles (for basic usage without context)
  ...
  // Responsive Text Styles (with context for true responsiveness)
  static TextStyle heading1Responsive(BuildContext context) => TextStyle(
  ...
  static TextStyle heading2Responsive(BuildContext context) => TextStyle(
  ...
  static TextStyle heading3Responsive(BuildContext context) => TextStyle(
  ...
  static TextStyle heading4Responsive(BuildContext context) => TextStyle(
  ...
  static TextStyle bodyLargeResponsive(BuildContext context) => TextStyle(
  ...
  static TextStyle bodyMediumResponsive(BuildContext context) => TextStyle(
  ...
  static TextStyle bodySmallResponsive(BuildContext context) => TextStyle(
  ...
  static TextStyle captionResponsive(BuildContext context) => TextStyle(
  ...
  static ButtonStyle primaryButton(BuildContext context) =>
      ElevatedButton.styleFrom(
        ...
        textStyle:
            bodyMediumResponsive(context).copyWith(fontWeight: FontWeight.w600),
  ...
  // Static Spacing Constants (for basic usage without context)
  ...
  // Responsive Spacing (with context for true responsiveness)
  static double spacingXSResponsive(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 4);
  static double spacingSResponsive(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 8);
  static double spacingMResponsive(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 16);
  static double spacingLResponsive(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 24);
  static double spacingXLResponsive(BuildContext context) =>
  ...
  static double elevationS(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 2);
  static double elevationM(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 4);
  static double elevationL(BuildContext context) =>
      ResponsiveUtils.getResponsiveSpacing(context, 8);
  ...
  static double containerHeightSmall(BuildContext context) =>
      ResponsiveUtils.getResponsiveContainerHeight(context, 40);
  static double containerHeightMedium(BuildContext context) =>
      ResponsiveUtils.getResponsiveContainerHeight(context, 60);
  static double containerHeightLarge(BuildContext context) =>
      ResponsiveUtils.getResponsiveContainerHeight(context, 80);

  // Responsive List Item Heights
  static double listItemHeight(BuildContext context) =>
      ResponsiveUtils.getResponsiveListTileHeight(context);
  ...
  static AppBarTheme appBarTheme(BuildContext context) => AppBarTheme(
        ...
        titleTextStyle:
            heading3Responsive(context).copyWith(color: Colors.white),
  ...
  static BottomNavigationBarThemeData bottomNavTheme(BuildContext context) =>
      BottomNavigationBarThemeData(
        selectedLabelStyle:
            bodySmallResponsive(context).copyWith(fontWeight: FontWeight.w600),
        unselectedLabelStyle: bodySmallResponsive(context),
  ...
  static FloatingActionButtonThemeData fabTheme(BuildContext context) =>
