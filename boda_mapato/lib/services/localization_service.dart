...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'category_has_products_warning': 'This category has products. Deleting it may affect them.',
      ...
      'count_by_batch': 'Count by batch instead of whole product',
      ...
      'batch_number_auto_hint': 'Leave blank to auto-generate (e.g. SKU-0001)',
      ...
      'stock_auto_restored': 'Stock will be restored automatically.',
      'sku_code': 'SKU Code',
      'auto_generate_sku': 'Auto-generate SKU',
      'inventory_pricing': 'Inventory & Pricing',
      'cost_price_per': 'Cost Price (per 1',
      'selling_price_per': 'Selling Price (per 1',
      'unit_quantity': 'Qty per Unit',
      'filter_by_officer': 'Filter by sales officer',
      'all_officers': 'All Officers',
      'quantity_in_stock': 'Quantity in Stock',
      'stock_alert_threshold': 'Stock Alert Threshold',
      'low_stock_alert': 'Low Stock Alert',
      'barcode_qr': 'Barcode / QR Code',
      'auto_filled_from_sku': 'Auto-filled from SKU',
      'auto_synced_with_sku': 'Auto-synced with SKU',
      'reset_to_sku': 'Reset to SKU',
      'qr_preview': 'QR Preview',
      'barcode_equals_sku': 'Barcode = SKU (recommended)',
      ...
      'sizes_variants': 'Sizes / Variants',
      'profit_hint': 'Profit per unit = Selling Price − Cost Price',
      'filter_by_product': 'Filter by Product',
      'all_products': 'All Products',
      'sale_receipt': 'Sale Receipt',
      'receipt_settings': 'Receipt Settings',
      'print_share_options': 'Print / Share Options',
      'print_receipt_current_view': 'Print Receipt (Current View)',
      'print_receipt_current_view_sub': 'Print receipt as shown on screen',
      'share_receipt_image': 'Share Receipt Image',
      'share_receipt_image_sub': 'Send PNG image — WhatsApp, email, etc.',
      'print_share_colored_pdf': 'Print / Share Colored PDF',
      'print_share_colored_pdf_sub': 'PDF file — A4, email or save',
      'thermal_80mm': 'Thermal 80mm Version',
      'thermal_80mm_sub': 'Black-white · monospace · for receipt printers',
      ...
      'discount': 'Discount',
      'tax_vat': 'Tax (VAT)',
      'status_paid_label': 'PAID IN FULL',
      'status_debt_label': 'DEBT',
      ...
      'cancel_reason_hint': 'e.g. Customer changed mind',
      'confirm_cancel': 'Confirm Cancellation',
      'sale_cancelled_stock_restored': 'Sale cancelled, stock restored',
      'failed_to_cancel_sale': 'Failed to cancel sale',
      ...
      'warehouse_expenses': 'Warehouse Expenses',
      ...
      'code': 'Code',
      'total_products_abbr': 'T.products',
      'none': 'None',
      'upload_capture': 'Upload / Capture',
      // Orders
      ...
      'supplies': 'Supplies',
      'marketing': 'Marketing',
      // Expenses screen labels
      'record_expenses': 'Record Expenses',
      'expense_type': 'Expense Type',
      'description_required': 'Description (required)',
      'amount_tzs': 'Amount (TZS)',
      'confirm_delete_expense': 'Delete Expense',
      'confirm_delete_expense_body': 'Are you sure you want to delete this expense?',
      'expense_by_type': 'Expenses by Type',
      'count': 'Count',
      'total': 'Total',
      'income': 'Income',
      'net_profit': 'Net Profit',
      'description_required_error': 'Enter description',
      'amount_required_error': 'Enter valid amount',
      ...
      'report_product_profitability': 'Product Profitability',
      'report_stock_valuation': 'Stock Valuation',
      'report_stock_movements': 'Stock Movements',
      'report_stock_count_variance': 'Stock Count Variance',
      'report_damages': 'Damages & Write-offs',
      'report_debtors_ageing': 'Debtors Ageing',
      'report_collections': 'Collections',
      'report_crates_position': 'Crates Position',
      'report_purchases': 'Purchases',
      'report_cash_reconciliation': 'Cash Reconciliation',
      'profit_margins_title': 'Product Profit Margins',
      'rank': 'No.',
      'top_products_sorted': 'Sorted by sales',
      'this_week': 'This Week',
      ...
      'decrease': 'Decrease',
      'increase': 'Increase',
      'revenue_growth_improved': 'Revenue is trending up compared to the previous period.',
      'revenue_growth_declined': 'Revenue has slowed compared to the previous period.',
      'expenses_reduced_management': 'Expenses are lower than the previous period -- good cost control.',
      'expenses_increased_warning': 'Expenses are higher than the previous period -- worth a closer look.',
      'added_customers_this_month': 'New paying customers gained this period.',
      'best_day_insight_title': 'Best earning day',
      'best_time_insight_title': 'Best earning time',
      'fuel_usage_reduced': 'Fuel spend is down',
      'fuel_usage_increased': 'Fuel spend is up',
      'no_insights_yet': 'Not enough data yet to show insights for this period.',
      'monday': 'Monday',
      'tuesday': 'Tuesday',
      'wednesday': 'Wednesday',
      'thursday': 'Thursday',
      ...
      'saturday': 'Saturday',
      'sunday': 'Sunday',
      'time_bucket_morning': 'Morning (5am-12pm)',
      'time_bucket_afternoon': 'Afternoon (12pm-5pm)',
      'time_bucket_evening': 'Evening (5pm-9pm)',
      'time_bucket_night': 'Night (9pm-5am)',
      'filter_btn': 'Filter',
      'sales_count': 'No. of Sales',
      'inv_valuation_title': 'Inventory Valuation',
      'expected_profit': 'Expected Profit',
      'revenue': 'Revenue',
      'choose_period': 'Choose Period',
      'apply': 'Apply',
      'sell': 'Sell',
      'no_chart_data': 'No chart data for this period',
      ...
      'receipt_settings_title': 'Receipt Settings',
      'settings_tab': 'Settings',
      'preview_tab': 'Receipt Preview',
      'shop_identity': 'Shop Identity',
      'shop_name_required': 'Shop Name *',
      'tagline': 'Tagline',
      'contact_info': 'Contact Info',
      'website': 'Website / Social',
      'legal': 'Legal',
      'tin_number': 'TIN (Tax ID Number)',
      'show_tin_on_receipt': 'Show TIN on receipt',
      'footer_message': 'Footer Message',
      'footer_note': 'Receipt Footer Message',
      'show_barcode_on_receipt': 'Show barcode on receipt',
      'preview_receipt_layout': 'Preview receipt layout',
    ...
    'sw': {
      ...
      'out_of_stock': 'Bidhaa zimekwisha',
      'in_stock': 'Bidhaa ipo',
      'snoozed_a_day': 'Imesitishwa kwa siku moja',
      'snooze_a_day': 'Sitisha kwa siku moja',
      'stock_in_note':
          'Tumia hii wakati bidhaa mpya inapowasili nje ya oda rasmi ya manunuzi — mfano nyongeza ndogo iliyonunuliwa kwa taslimu. Ongeza namba ya bechi na tarehe ya mwisho ili programu iweze kuifuatilia vizuri.',
      'stock_out_note':
          'Tumia hii kwa sampuli, zawadi, au marekebisho tu — hizi hutoka mara moja, hazihitaji idhini. Bidhaa zilizoharibika, zilizoisha muda, au zilizoibiwa lazima zipite kwenye Hasara za Bidhaa, kwani hizo zinahitaji meneja aidhinishe kabla bidhaa haijaondolewa.',
      ...
      'units': 'vipimo',
      'stock_transfer_note':
          'Tumia hii kuhamisha bidhaa kutoka bechi moja kwenda bechi mpya au iliyopo ya bidhaa hiyohiyo, mfano baada ya kufungasha upya. Jumla ya bidhaa haibadiliki.',
      'quantity_received': 'Idadi iliyopokelewa',
      'add_stock': 'Ongeza bidhaa',
      'remove_stock': 'Ondoa bidhaa',
      'move_stock': 'Hamisha bidhaa',
      ...
      'stock_updated': 'Bidhaa imesasishwa',
      ...
      'edit_brand': 'Hariri chapa',
      'brand_name': 'Jina la chapa',
      'brands': 'Chapa',
      'no_brands_found': 'Hakuna chapa zilizopatikana',
      'actions': 'Vitendo',
      'failed_to_delete': 'Imeshindikana kufuta',
      'failed_to_save': 'Imeshindikana kuhifadhi',
      'category_has_products_warning': 'Jamii hii ina bidhaa. Kufuta kunaweza kuathiri bidhaa hizo.',
      ...
      'no_sales_found': 'Hakuna mauzo',
      'stock_auto_restored': 'Hifadhi ya bidhaa itarejeshwa otomatiki.',
      'sku_code': 'Nambari ya SKU',
      'auto_generate_sku': 'Tengeneza SKU Otomatiki',
      'inventory_pricing': 'Hifadhi & Bei',
      'cost_price_per': 'Bei ya Kununua (kwa 1',
      'selling_price_per': 'Bei ya Kuuza (kwa 1',
      'unit_quantity': 'Kiasi kwa Kipimo',
      'filter_by_officer': 'Chuja kwa afisa mauzo',
      'all_officers': 'Maafisa Wote',
      'quantity_in_stock': 'Kiasi Kilichopo',
      'stock_alert_threshold': 'Kiwango cha Tahadhari',
      'low_stock_alert': 'Tahadhari ya Hifadhi Chini',
      'barcode_qr': 'Baakodi / QR Code',
      'auto_filled_from_sku': 'Imejazwa Otomatiki kutoka SKU',
      'auto_synced_with_sku': 'Imesawazishwa Otomatiki na SKU',
      'reset_to_sku': 'Rudisha kwenye SKU',
      'qr_preview': 'Maoni ya QR',
      'barcode_equals_sku': 'Baakodi = SKU (inashauriwa)',
      'custom_barcode': 'Baakodi Maalum',
      'created_by': 'Imeundwa na',
      'size_pack': 'Ukubwa/Pakiti',
      'qty_label': 'Idadi',
      'actual_price': 'Bei Halisi',
      'discounted_price': 'Bei ya Punguzo',
      'sizes_variants': 'Ukubwa / Bidhaa Tofauti',
      'profit_hint': 'Faida kwa kitengo = Bei ya Kuuza − Bei ya Kununua',
      'filter_by_product': 'Chuja kwa Bidhaa',
      'all_products': 'Bidhaa Zote',
      'sale_receipt': 'Risiti ya Mauzo',
      'receipt_settings': 'Mpangilio wa Risiti',
      'print_share_options': 'Chaguo za Chapisha / Shiriki',
      'print_receipt_current_view': 'Chapisha Risiti (Muonekano wa Sasa)',
      'print_receipt_current_view_sub': 'Chapisha risiti kama inavyoonekana kwenye skrini',
      'share_receipt_image': 'Shiriki Picha ya Risiti',
      'share_receipt_image_sub': 'Tuma picha PNG — WhatsApp, email, n.k.',
      'print_share_colored_pdf': 'Chapisha / Shiriki PDF ya Rangi',
      'print_share_colored_pdf_sub': 'Faili PDF — A4, email au kuhifadhi',
      'thermal_80mm': 'Toleo la Thermal 80mm',
      'thermal_80mm_sub': 'Nyeusi-nyeupe · monospace · kwa printers za risiti',
      'outstanding_balance': 'Deni linalobaki',
      'thank_you': 'ASANTE SANA!',
      'items_header': 'BIDHAA',
      'grand_total': 'JUMLA YOTE',
      'payments_section': 'MALIPO',
      'payment_method_label': 'Njia ya Malipo',
      'total_paid': 'Jumla Iliyolipwa',
      'change': 'Chenji',
      'discount': 'Punguzo',
      'tax_vat': 'Kodi (VAT)',
      'status_paid_label': 'MALIPO KAMILI',
      'status_debt_label': 'DENI',
      'status_partial_label': 'SEHEMU',
      'method_cash': 'Taslimu',
      'method_mobile_money': 'M-Pesa / Simu',
      'method_bank': 'Benki',
      'method_cheque': 'Hundi',
      'payment_status_label': 'Hali ya Malipo',
      'receipt_settings_title': 'Mpangilio wa Risiti',
      'settings_tab': 'Mipangilio',
      'preview_tab': 'Muundo wa Risiti',
      'shop_identity': 'Kitambulisho cha Duka',
      'shop_name_required': 'Jina la Duka *',
      'tagline': 'Kauli Mbiu',
      'contact_info': 'Mawasiliano',
      'website': 'Tovuti / Mitandao',
      'legal': 'Kisheria',
      'tin_number': 'TIN (Nambari ya Kodi)',
      'show_tin_on_receipt': 'Onyesha TIN kwenye risiti',
      'footer_message': 'Maandishi ya Mwisho',
      'footer_note': 'Ujumbe wa Chini ya Risiti',
      'show_barcode_on_receipt': 'Onyesha msimbo wa bar (barcode)',
      'preview_receipt_layout': 'Angalia muundo wa risiti',
      'save_settings': 'Hifadhi Mipangilio',
      'pay_debt': 'Lipa Deni',
      'cancel_sale': 'Ghairi Mauzo',
      'view_receipt': 'Angalia Risiti',
      'print_share': 'Chapisha / Shiriki',
      'cancel_reason': 'Sababu ya kughairi',
      'cancel_reason_hint': 'mfano: Mteja alibadilisha nia',
      'confirm_cancel': 'Thibitisha Kughairi',
      'sale_cancelled_stock_restored': 'Mauzo yameghairiwa, hifadhi imerejeshewe',
      'failed_to_cancel_sale': 'Imeshindwa kughairi mauzo',
      'failed_to_record_payment': 'Imeshindwa kurekodi malipo',
      ...
      'remaining': 'Iliyobaki',
      'unit_cost': 'Bei ya Kitengo',
      'order_ref': 'Nambari ya Oda',
      'product_id': 'Nambari ya Bidhaa',
      ...
      'load_removes_stock_note': 'Kupakia huondoa bidhaa hii ghalani sasa.',
      'reconcile_note': 'Bidhaa isiyouzwa hurudi ghalani unapolinganisha.',
      'insufficient_stock_or_failed': 'Bidhaa haitoshi, au ombi limeshindikana',
      ...
      'low_stock_threshold': 'Kikomo cha bidhaa ndogo',
      ...
      'stock_counts': 'Hesabu za bidhaa',
      'stock_count': 'Hesabu ya bidhaa',
      'new_stock_count': 'Hesabu mpya',
      'no_stock_counts': 'Hakuna hesabu za bidhaa bado',
      'nothing_counted_yet': 'Hakuna kilichohesabiwa bado',
      'count_item': 'Hesabu bidhaa',
      'count_by_batch': 'Hesabu kwa bechi badala ya bidhaa yote',
      ...
      'approve_removes_stock': 'Kuidhinisha kutaondoa bidhaa hii',
      'decision_note': 'Maelezo ya uamuzi',
      'submitted_for_approval': 'Imewasilishwa kwa idhini',
      'write_off_needs_approval_note':
          'Bidhaa huondolewa tu baada ya meneja kuidhinisha.',
      'approve': 'Idhinisha',
      'reject': 'Kataa',
      ...
      'batch_number_auto_hint': 'Acha wazi ili ipangwe kiotomatiki (mfano SKU-0001)',
      'no_batches': 'Hakuna bechi',
      'search_batches': 'Tafuta bechi',
      'receive_stock': 'Pokea bidhaa',
      'stock_received': 'Bidhaa imepokelewa',
      'buying_cost': 'Gharama ya ununuzi',
      'expiry_date': 'Tarehe ya mwisho',
      'expiring_soon': 'Karibu kuisha',
      'no_expiry': 'Hakuna tarehe',
      'stock_value': 'Thamani ya bidhaa',
      'left': 'zimebaki',
      'cost': 'Gharama',
      'value': 'Thamani',
      'not_set': 'Haijawekwa',
      ...
      'warehouse_expenses': 'Matumizi ya Ghala',
      'add_category': 'Ongeza Aina',
      'edit_category': 'Hariri Aina',
      'save_category': 'Hifadhi Aina',
      'category_details': 'Maelezo ya Aina',
      'category_name': 'Jina la Aina',
      'category_name_required': 'Jina la aina linahitajika',
      'parent_category_optional': 'Aina Kuu (hiari)',
      'no_categories_found': 'Hakuna makundi yaliyopatikana',
      'code': 'Msimbo',
      'total_products_abbr': 'Jumla',
      'none': 'Hakuna',
      'upload_capture': 'Pakia / Piga Picha',
      // Orders
      'all_orders': 'Oda Zote',
      ...
      'marketing': 'Masoko',
      // Expenses screen labels
      'record_expenses': 'Rekodi Matumizi',
      'expense_type': 'Aina ya Matumizi',
      'description_required': 'Maelezo (Lazima)',
      'amount_tzs': 'Kiasi (TZS)',
      'confirm_delete_expense': 'Futa Matumizi',
      'confirm_delete_expense_body': 'Una uhakika wa kufuta matumizi haya?',
      'expense_by_type': 'Matumizi kwa Aina',
      'count': 'Namba',
      'total': 'Jumla',
      'income': 'Mapato',
      'net_profit': 'Faida Halisi',
      'description_required_error': 'Jaza maelezo',
      'amount_required_error': 'Jaza kiasi sahihi',
      ...
      'low_stock_alerts': 'Tahadhari ya Stoo',
      // Report tile titles
      'report_daily_sales': 'Mauzo ya Kila Siku',
      'report_sales_detail': 'Maelezo ya Mauzo',
      'report_product_profitability': 'Faida kwa Bidhaa',
      'report_stock_valuation': 'Thamani ya Stoo',
      'report_stock_movements': 'Mwendo wa Stoo',
      'report_stock_count_variance': 'Tofauti ya Hesabu za Stoo',
      'report_damages': 'Uharibifu na Hasara',
      'report_debtors_ageing': 'Umri wa Madeni',
      'report_collections': 'Makusanyo',
      'report_crates_position': 'Hali ya Masanduku',
      'report_purchases': 'Manunuzi',
      'report_cash_reconciliation': 'Upatanisho wa Fedha',
      'credit': 'Mikopo',
      'profit_margins_title': 'Faida kwa Bidhaa',
      'rank': 'Namba',
      'top_products_sorted': 'Zimepangwa kwa mauzo',
      'this_week': 'Wiki hii',
      'this_month': 'Mwezi huu',
      'this_year': 'Mwaka huu',
      'custom_range': 'Chaguo',
      // Dashibodi ya takwimu za usafiri
      'weekly': 'Wiki',
      'monthly': 'Mwezi',
      'yearly': 'Mwaka',
      'revenue_growth': 'Ukuaji wa Mapato',
      'expense_efficiency': 'Ufanisi wa Matumizi',
      'customer_performance': 'Utendaji wa Wateja',
      'new_customers': 'Wateja Wapya',
      'profit_margin': 'Kiwango cha Faida',
      'decrease': 'Kupungua',
      'increase': 'Kuongezeka',
      'revenue_growth_improved': 'Mapato yanaongezeka ukilinganisha na kipindi kilichopita.',
      'revenue_growth_declined': 'Mapato yamepungua kasi ukilinganisha na kipindi kilichopita.',
      'expenses_reduced_management': 'Matumizi yamepungua kuliko kipindi kilichopita -- udhibiti mzuri wa gharama.',
      'expenses_increased_warning': 'Matumizi yameongezeka kuliko kipindi kilichopita -- yanahitaji kuangaliwa.',
      'added_customers_this_month': 'Wateja wapya walioongezeka katika kipindi hiki.',
      'best_day_insight_title': 'Siku bora ya mapato',
      'best_time_insight_title': 'Muda bora wa mapato',
      'fuel_usage_reduced': 'Matumizi ya mafuta yamepungua',
      'fuel_usage_increased': 'Matumizi ya mafuta yameongezeka',
      'no_insights_yet': 'Bado hakuna taarifa za kutosha kuonyesha maarifa kwa kipindi hiki.',
      'monday': 'Jumatatu',
      'tuesday': 'Jumanne',
      'wednesday': 'Jumatano',
      'thursday': 'Alhamisi',
      ...
      'saturday': 'Jumamosi',
      'sunday': 'Jumapili',
      'time_bucket_morning': 'Asubuhi (5-12)',
      'time_bucket_afternoon': 'Mchana (12-5)',
      'time_bucket_evening': 'Jioni (5-9)',
      'time_bucket_night': 'Usiku (9-5)',
      'filter_btn': 'Chuja',
      'sales_count': 'Idadi ya Mauzo',
      'inv_valuation_title': 'Muhtasari wa Mzigo',
      'expected_profit': 'Faida Tarajiwa',
      'revenue': 'Mapato',
      'choose_period': 'Chagua Kipindi',
      'apply': 'Tumia',
      'sell': 'Uza',
      'no_chart_data': 'Hakuna data ya chati kipindi hiki',
      'products_overview': 'Muhtasari wa Bidhaa',
      'signing_in': 'Inaingia…',
      'quantity': 'Kiasi',
