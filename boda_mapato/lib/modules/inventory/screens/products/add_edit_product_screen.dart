...
class _AddEditProductScreenState extends State<AddEditProductScreen> {
  ...
  void _onNameChanged() {
    if (_isSkuAutoGenerated && widget.productId == null) {
  ...
  Future<void> _onSave() async {
    ...
    if (widget.productId != null) {
      // Editing an existing product is not wired to the backend yet.
      ThemeConstants.showInfoSnackBar(context, 'Product saved (UI only).');
      return;
    }

    setState(() => _saving = true);
    final bool ok = await context.read<InventoryProvider>().createProduct(
