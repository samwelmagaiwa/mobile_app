...
class _AppLandingScreenState extends State<AppLandingScreen>
  ...
  static const List<_ServiceSlide> _slides = [
    _ServiceSlide(
      ...
      titleEn: 'E-Sales',
      titleSw: 'E-Mauzo',
      taglineEn: 'Sales · Purchases · Revenue · Debts',
      taglineSw: 'Mauzo · Manunuzi · Mapato · Madeni',
      features: [
    ...
    _ServiceSlide(
      ...
      titleEn: 'E-Tenants',
      titleSw: 'E-Wapangaji',
      taglineEn: 'Apartments · Properties · Collections',
      taglineSw: 'Nyumba · Apartments · Makusanyo',
      features: [
    ...
    _ServiceSlide(
      ...
      titleEn: 'E-Transport',
      titleSw: 'E-Usafiri',
      taglineEn: 'Driver returns · Fleet · Payments',
      taglineSw: 'Marejesho ya Madereva · Magari · Malipo',
      features: [
