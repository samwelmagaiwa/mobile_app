...
class _DriversManagementScreenState extends State<DriversManagementScreen>
            ...
            Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  height: 60,
                  decoration: BoxDecoration(
                    color: isActive ? successGreen : Colors.grey, // Solid color based on status
  ...
  void _showEditDriverDialog(final Driver driver) {
    // TODO: Implement edit driver dialog with real API call
    showDialog(
      context: context,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        items: _statusOptions.entries.map((final MapEntry<String, String> entry) => DropdownMenuItem<String>(
                            value: entry.key,
                            child: Text(
                              entry.value,
                              overflow: TextOverflow.ellipsis,
