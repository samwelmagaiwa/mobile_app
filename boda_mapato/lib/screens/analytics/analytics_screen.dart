...
class _AnalyticsScreenState extends State<AnalyticsScreen> {
  ...
  double _calculateProfitMargin(Map<String, dynamic>? revenueData, Map<String, dynamic>? expenseData) {
    if (revenueData == null || expenseData == null) return 25.0;
        ...
        children: <Widget>[
          Expanded(
            child: _MetricCard(
              ...
              value: "TSh ${_analyticsData?['revenue']?['total_revenue'] ?? 450000}",
          ...
          Expanded(
            child: _MetricCard(
              title: "Faida Halisi",
              value: "TSh ${(_analyticsData?['revenue']?['total_revenue'] ?? 450000) - (_analyticsData?['expenses']?['total_expenses'] ?? 125000)}",
              change: "+8.2%",
              isPositive: true,
        ...
        children: <Widget>[
          Expanded(
            child: _MetricCard(
              ...
              value: "${_analyticsData?['profit_margin']?.toStringAsFixed(1) ?? '25.0'}%",
              change: "+2.1%",
              isPositive: true,
          ...
          Expanded(
            child: _MetricCard(
              title: "Wateja Wapya",
              value: "${_analyticsData?['revenue']?['new_customers'] ?? 15}",
              change: "+18.5%",
              isPositive: true,
